...
R_cbox = zeros(200,2); cbox = R_case1;
R_cbox[:,1] = cbox.d; R_cbox[:,2] = cbox.u; table_R = Tables.table(R_cbox);
CSV.write("C:\\Users\\snrltsa\\Desktop\\R_case1.csv", table_R) # Save Pbox output cbox as CSV
...
R_cbox = zeros(200,2); cbox = R_case2;
R_cbox[:,1] = cbox.d; R_cbox[:,2] = cbox.u; table_R = Tables.table(R_cbox);
CSV.write("C:\\Users\\snrltsa\\Desktop\\R_case2.csv", table_R) # Save Pbox output cbox as CSV
...
R_cbox = zeros(200,2); cbox = R_case3;
R_cbox[:,1] = cbox.d; R_cbox[:,2] = cbox.u; table_R = Tables.table(R_cbox);
CSV.write("C:\\Users\\snrltsa\\Desktop\\R_case3.csv", table_R) # Save Pbox output cbox as CSV
...
R_cbox = zeros(200,2); cbox = R_case4;
R_cbox[:,1] = cbox.d; R_cbox[:,2] = cbox.u; table_R = Tables.table(R_cbox);
CSV.write("C:\\Users\\snrltsa\\Desktop\\R_case4.csv", table_R) # Save Pbox output cbox as CSV

################################################################################################################################################
## Consider the Parallel-Series bridge system with 5 components using the mean reliability estimates:
